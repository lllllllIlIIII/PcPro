...
if (isset($_POST['btn_connecter'])) {
    ...
    if (!empty($email) && !empty($mdp)) {
        // ... à l'intérieur du traitement de connexion ...
        $userData = $userDAO->getUserByEmail($email);

// On vérifie 'mdp' car c'est le nom dans ta base
...
<div class="container mt-5 mb-5">
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <?php if ($erreur): ?>
                <div class="alert alert-danger text-center shadow-sm py-2"><?php echo $erreur; ?></div>
            <?php endif; ?>
            ...
            <div class="card shadow-sm border-light bg-light">
                <div class="card-body p-4 p-md-5">
                    <form action="index.php?page=connexion" method="POST">
                        ...
                        <button type="submit" name="btn_connecter" class="btn btn-dark w-100 fw-bold shadow-sm">Se connecter</button>
                    </form>

                    <div class="text-center mt-4">
                        <p class="text-muted small mb-0">Pas encore de compte ? <a href="index.php?page=inscription" class="text-dark fw-bold text-decoration-none">S'inscrire</a></p>
                    </div>
                </div>
            </div>
