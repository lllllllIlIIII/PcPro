...
// 1. SÉCURITÉ : BARRAGE DE CONNEXION
...
if (isset($_POST['btn_ajouter_sur_mesure'])) {
    ...
    if (empty($cpu) || empty($mb) || empty($gpu) || empty($ram) || empty($stock) || empty($case)) {
        ...
        $message_panier = "<div class='alert alert-success mt-3 shadow-sm font-monospace rounded-0 tech-alert-success'>Configuration validée et ajoutée au module de transport (Panier) !</div>";
    }
}
?>
