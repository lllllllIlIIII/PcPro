<?php
// 1. On récupère la connexion et le DAO
global $pdo;
$modeleDAO = new CatalogueDAO($pdo);

// 2. On récupère tous les PC
$toutLeCatalogue = $modeleDAO->getAllcatalogue();

// 3. On ne prend que les 3 premiers pour l'accueil (les tops ventes)
...
<!-- 2. SECTION RÉASSURANCE (Pourquoi nous choisir) -->
...
<!-- 3. SECTION BEST-SELLERS (Les 3 PC) -->
