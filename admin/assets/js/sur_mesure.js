document.addEventListener('DOMContentLoaded', () => {
    ...
    // Petite fonction pratique pour récupérer l'ID (data-id) au lieu du nom (value)
    ...
    const mettreAJourPrix = () => {
        // On construit les données avec l'ID pour que calcul_prix.php puisse travailler
        const data = {
        ...
        fetch('admin/src/php/ajax/calcul_prix.php', {
            ...
            .then(resultat => {
                if (affichagePrix) {
                    ...
                    // On met à jour le champ caché pour PHP
                    if (prixCache) {
